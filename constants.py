...
cons = {   'select_your_language' : "Выберите язык \nSelect your language",
	...
	'eng' : {'language' : 'English',
             'contacts' : {'message' : 'Contact number: \n+7 913 8201 503. \nCall hours: 24/7. \nAddress: Moskovsky tract, 2. \nOffice hours:9:00 – 17:00, Mo-Fr. Please call before visiting', 'button text': 'link','url' : 'https://docs.google.com/forms/d/e/1FAIpQLSeScqQbahviJXzEKrOc4H1X3S_z2dazgB9kfvQRaWTJGRRpUA/viewform'}
            }
